...
const screenshotDir = path.join(process.cwd(), "audit-results", "v840-screenshots");
const routes = [
  "/taskuri",
  "/taskuri/overview",
  "/taskuri/my-work",
...
await fs.writeFile(path.join(process.cwd(), "audit-results", "V8_4_0_SCREENSHOT_AUDIT_REPORT.md"), report.join("\n"), "utf8");
