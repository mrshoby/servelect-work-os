param(
  ...
  [string]$OutputDir = "C:\Users\Vlad Taran\Downloads\SERVELECT_WORK_OS_v6.4.12_REAL_SCREENSHOTS",
  [int]$Port = 3100,
  [string]$BrowserPath = "",
  [string]$BaseUrl = "",
  [switch]$SkipStart,
...
Ruleaza cu -BrowserPath explicit, de exemplu:
  .\scripts\RUN_SERVELECT_WORK_OS_V6_4_12_POST_BUILD_SCREENSHOT_AUDIT.ps1 -BrowserPath "C:\Program Files\Microsoft\Edge\Application\msedge.exe"
  .\scripts\RUN_SERVELECT_WORK_OS_V6_4_12_POST_BUILD_SCREENSHOT_AUDIT.ps1 -BrowserPath "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"
  .\scripts\RUN_SERVELECT_WORK_OS_V6_4_12_POST_BUILD_SCREENSHOT_AUDIT.ps1 -BrowserPath "C:\Program Files\Google\Chrome\Application\chrome.exe"
"@
