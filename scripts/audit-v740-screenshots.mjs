...
const outDir = path.join(process.cwd(), "audit-results", "v74-screenshots");
...
const reportPath = path.join(process.cwd(), "audit-results", "V7_4_0_SCREENSHOT_AUDIT_REPORT.md");
