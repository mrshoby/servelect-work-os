...
Write-Host "=== SERVELECT WORK OS v3.2 Prisma Task Read Shadow Verification Test ===" -ForegroundColor Cyan
...
Write-Host "`nOK: toate endpointurile v3.2 au raspuns cu ok=true." -ForegroundColor Green
