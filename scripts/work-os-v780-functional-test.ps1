...
$Routes = @(
  ...
  "/api/v1/work-os/v78-provider-telemetry",
  "/api/v1/work-os/v78-provider-telemetry/health",
  "/api/v1/work-os/v78-provider-telemetry/telemetry",
  "/api/v1/work-os/v78-provider-telemetry/saved-views",
  "/api/v1/work-os/v78-provider-telemetry/mutation-canary",
  "/api/v1/work-os/v78-provider-telemetry/observability"
)
...
$Report = Join-Path $OutDir "v780-provider-telemetry-functional-routes.md"
...
if ($Failed -gt 0) { throw ("v7.8.0 functional route smoke failed: " + $Failed + " route(s). Protected 401 routes: " + $Protected + ". See " + $Report) }
Write-Host "v7.8.0 functional route smoke passed: $($Routes.Count) / $($Routes.Count)" -ForegroundColor Green
