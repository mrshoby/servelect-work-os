...
$OutputDir = Join-Path $env:USERPROFILE "Downloads\SERVELECT_WORK_OS_v6.4.14_REAL_SCREENSHOTS"
...
$reportLines = @("# SERVELECT WORK OS v6.4.14 real screenshot audit", "", "Browser: $Browser", "BaseUrl: $BaseUrl", "OutputDir: $OutputDir", "Generated: $(Get-Date -Format o)", "", "| Screen | Route | HTTP | Screenshot | Status |", "|---|---|---:|---|---|")
