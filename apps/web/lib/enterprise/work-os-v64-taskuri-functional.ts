...
export const v64Projects: V64Project[] = [
  ...
  ,{ id: "p9", code: "P-2024-0179", name: "Parc fotovoltaic Arad", client: "GreenEnergy SA", valueRon: 3750000, managerId: "u2", departmentId: "productie", phase: "Predare amplasament", status: "active", progress: 35, health: "Risc", startDate: "2024-04-12", deadline: "2024-04-30", budgetConsumedPercent: 74, readyScore: 82, missingDocuments: ["Proces verbal acces"], kickoffChecklist: [] }
  ,{ id: "p10", code: "P-2024-0183", name: "Stație încărcare EV – Timișoara", client: "ChargePoint SRL", valueRon: 980000, managerId: "u6", departmentId: "automatizari", phase: "Obținere avize", status: "active", progress: 0, health: "Atenție", startDate: "2024-05-15", deadline: "2024-05-18", budgetConsumedPercent: 15, readyScore: 55, missingDocuments: ["Aviz distribuitor"], kickoffChecklist: [] }
  ,{ id: "p11", code: "P-2024-0168", name: "Microgrid Industrial", client: "InduTech SA", valueRon: 780000, managerId: "u11", departmentId: "automatizari", phase: "Proiectare", status: "upcoming", progress: 0, health: "Planificat", startDate: "2024-06-10", deadline: "2024-08-30", budgetConsumedPercent: 0, readyScore: 58, missingDocuments: ["Plan de securitate"], kickoffChecklist: [] }
  ,{ id: "p12", code: "P-2024-0195", name: "Instalație FV 1,2 MWp", client: "TechConstruct SRL", valueRon: 5480000, managerId: "u2", departmentId: "productie", phase: "Pre-start", status: "upcoming", progress: 0, health: "În pregătire", startDate: "2024-06-10", deadline: "2024-09-15", budgetConsumedPercent: 0, readyScore: 71, missingDocuments: ["Aviz distribuitor"], kickoffChecklist: [] }
  ,{ id: "p13", code: "P-2024-0199", name: "Sistem stocare BESS 2 MWh", client: "ElectroHub SA", valueRon: 3750000, managerId: "u11", departmentId: "automatizari", phase: "Pre-start", status: "upcoming", progress: 0, health: "Planificat", startDate: "2024-06-17", deadline: "2024-09-30", budgetConsumedPercent: 0, readyScore: 58, missingDocuments: ["Plan de siguranță"], kickoffChecklist: [] }
  ,{ id: "p14", code: "P-2024-0205", name: "Instalație FV 750 kWp", client: "SmartEnergy SA", valueRon: 2950000, managerId: "u8", departmentId: "comercial", phase: "Ofertare convertită", status: "upcoming", progress: 0, health: "În pregătire", startDate: "2024-06-24", deadline: "2024-10-10", budgetConsumedPercent: 0, readyScore: 45, missingDocuments: ["Plan de situație", "Studiu geotehnic"], kickoffChecklist: [] }
  ,{ id: "p15", code: "P-2024-0062", name: "TechConstruct SRL", client: "TechConstruct SRL", valueRon: 84200, managerId: "u2", departmentId: "productie", phase: "Handover", status: "completed", progress: 100, health: "Finalizat", startDate: "2024-02-01", deadline: "2024-05-15", budgetConsumedPercent: 99, readyScore: 100, missingDocuments: [], kickoffChecklist: [] }
  ,{ id: "p16", code: "P-2024-0077", name: "AgroSol Farm SRL", client: "AgroSol Farm SRL", valueRon: 145800, managerId: "u4", departmentId: "productie", phase: "Handover", status: "completed", progress: 100, health: "Finalizat", startDate: "2024-02-10", deadline: "2024-05-20", budgetConsumedPercent: 96, readyScore: 100, missingDocuments: [], kickoffChecklist: [] }
...
const v64BaseTasks: V64Task[] = [
  ...
  ,{ id: "P-2024-0179-T6", title: "Instalare panouri și cablare DC", description: "Instalare panouri și cablare DC pentru etapa Arad.", projectId: "p9", projectCode: "P-2024-0179", projectName: "Parc fotovoltaic Arad", client: "GreenEnergy SA", type: "Task", status: "În desfășurare", priority: "Mediu", assigneeId: "u7", ownerId: "u2", reviewerId: "u3", createdBy: "u2", departmentId: "productie", departmentName: "Producție", startDate: "2024-05-22", dueDate: "2024-05-30", estimateHours: 6, trackedHours: 3, progress: 40, tags: ["cablare", "montaj"], checklist: [{ id: "cl1", label: "String A", done: true }, { id: "cl2", label: "String B", done: false }], subtasks: [], comments: [], attachments: [], dependencies: ["P-2024-0185-T6"], watchers: ["u1", "u2"], approvalStatus: "pending", customFields: { Putere: "750 kWp" }, activityLog: [activity("u7", "update", "Montaj 40%", 10)] }
  ,{ id: "P-2024-0183-T10", title: "Clarificări tehnice de la furnizor structuri", description: "Clarificare compatibilitate structură pentru stația EV.", projectId: "p10", projectCode: "P-2024-0183", projectName: "Stație încărcare EV – Timișoara", client: "ChargePoint SRL", type: "Task", status: "Blocat", priority: "Scăzut", assigneeId: "u11", ownerId: "u6", reviewerId: "u1", createdBy: "u6", departmentId: "automatizari", departmentName: "Automatizări", startDate: "2024-05-22", dueDate: "2024-05-28", estimateHours: 1.5, trackedHours: 0.1, progress: 10, tags: ["structuri", "clarificare"], checklist: [], subtasks: [], comments: [], attachments: [], dependencies: [], watchers: ["u1"], approvalStatus: "pending", customFields: { Furnizor: "Structuri" }, activityLog: [activity("u11", "blocked", "Clarificare solicitată", 11)] }
  ,{ id: "P-2024-0187-T11", title: "Revizie finală și listă punch-list", description: "Revizie finală și verificare punch-list proiect Halo Depot.", projectId: "p1", projectCode: "P-2024-0187", projectName: "Sistem FV 9.6 kWp", client: "Halo Retail SRL", type: "Task", status: "Review", priority: "Mediu", assigneeId: "u1", ownerId: "u2", reviewerId: "u1", createdBy: "u2", departmentId: "productie", departmentName: "Producție", startDate: "2024-05-24", dueDate: "2024-05-28", estimateHours: 2, trackedHours: 0.8, progress: 30, tags: ["pif", "finalizare"], checklist: [{ id: "cl1", label: "Punch-list verificat", done: false }], subtasks: [], comments: [], attachments: [], dependencies: [], watchers: ["u3"], approvalStatus: "pending", customFields: { Tip: "Finalizare" }, activityLog: [activity("u2", "review", "Trimis spre revizie", 12)] }
  ,{ id: "P-2024-0202-T12", title: "Avize distribuitor înainte de start", description: "Colectare avize distribuitor pentru proiectul EV.", projectId: "p5", projectCode: "P-2024-0202", projectName: "Stație încărcare EV 6x120 kW", client: "GreenRetail SA", type: "Document", status: "De făcut", priority: "Mediu", assigneeId: "u8", ownerId: "u8", createdBy: "u8", departmentId: "comercial", departmentName: "Comercial", startDate: "2024-05-20", dueDate: "2024-05-25", estimateHours: 2, trackedHours: 0, progress: 0, tags: ["avize", "pre-start"], checklist: [], subtasks: [], comments: [], attachments: [], dependencies: [], watchers: ["u1"], approvalStatus: "pending", customFields: { Tip: "Aviz" }, activityLog: [activity("u8", "created", "Task pre-start", 13)] }
  ,{ id: "P-2024-0210-T13", title: "Verificare amplasament pre-start", description: "Verificare amplasament pentru parc 5 MWp.", projectId: "p4", projectCode: "P-2024-0210", projectName: "Parc fotovoltaic 5 MWp", client: "AgroSol Farm SRL", type: "Task", status: "Planificat", priority: "Urgent", assigneeId: "u2", ownerId: "u1", createdBy: "u1", departmentId: "productie", departmentName: "Producție", startDate: "2024-05-17", dueDate: "2024-05-17", estimateHours: 2, trackedHours: 0, progress: 0, tags: ["teren"], checklist: [], subtasks: [], comments: [], attachments: [], dependencies: [], watchers: ["u1"], approvalStatus: "pending", customFields: { Etapă: "Pre-start" }, activityLog: [activity("u1", "created", "Task kickoff", 14)] }
...
export const v64CompletionStatus: V64CompletionStatus[] = [
  ...
  { label: "Taskuri 1:1 UI", percent: 94, notes: "Layout follows the 10 reference screenshots with the current Servelect shell." },
