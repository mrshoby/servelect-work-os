...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="project-hierarchy" />
      <V200GoodDayCompleteInteractionLayer routeKey="project-hierarchy" />
      <V210GoodDayRealMutationBridge routeKey="project-hierarchy" />
    </>);
}
