...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="collaboration-hub-v95" />
      <V200GoodDayCompleteInteractionLayer routeKey="collaboration-hub-v95" />
      <V210GoodDayRealMutationBridge routeKey="collaboration-hub-v95" />
    </>);
}
