...
export default function TaskuriPage() {
  return (
    <>
      <V150GoodDayStructuralTaskuriWorkspace routeKey="reports" />
      <V200GoodDayCompleteInteractionLayer routeKey="reports" />
      <V210GoodDayRealMutationBridge routeKey="reports" />
    </>
  );
}
