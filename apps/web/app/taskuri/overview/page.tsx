...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="overview" />
      <V200GoodDayCompleteInteractionLayer routeKey="overview" />
      <V210GoodDayRealMutationBridge routeKey="overview" />
    </>);
}
