...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="calendar-capacity-v94" />
      <V200GoodDayCompleteInteractionLayer routeKey="calendar-capacity-v94" />
      <V210GoodDayRealMutationBridge routeKey="calendar-capacity-v94" />
    </>);
}
