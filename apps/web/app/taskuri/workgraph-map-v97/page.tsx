...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="workgraph-map-v97" />
      <V200GoodDayCompleteInteractionLayer routeKey="workgraph-map-v97" />
      <V210GoodDayRealMutationBridge routeKey="workgraph-map-v97" />
    </>);
}
