...
export const metadata = { title: "Taskuri Updates Stream v9.1 | SERVELECT EMP" };

export default function Page() {
  return <V91GoodDayTaskExecutionParity initial={getV91Workspace()} view="updates" surface="taskuri" />;
}
