...
export const metadata = { title: "Taskuri Time Tracking v9.1 | SERVELECT EMP" };

export default function Page() {
  return <V91GoodDayTaskExecutionParity initial={getV91Workspace()} view="time-tracking" surface="taskuri" />;
}
