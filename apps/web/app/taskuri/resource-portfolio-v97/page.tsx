...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="resource-portfolio-v97" />
      <V200GoodDayCompleteInteractionLayer routeKey="resource-portfolio-v97" />
      <V210GoodDayRealMutationBridge routeKey="resource-portfolio-v97" />
    </>);
}
