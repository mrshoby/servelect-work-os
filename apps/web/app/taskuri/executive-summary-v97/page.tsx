...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="executive-summary-v97" />
      <V200GoodDayCompleteInteractionLayer routeKey="executive-summary-v97" />
      <V210GoodDayRealMutationBridge routeKey="executive-summary-v97" />
    </>);
}
