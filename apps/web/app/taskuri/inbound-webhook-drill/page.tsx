...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="inbound-webhook-drill" />
      <V200GoodDayCompleteInteractionLayer routeKey="inbound-webhook-drill" />
      <V210GoodDayRealMutationBridge routeKey="inbound-webhook-drill" />
    </>);
}
