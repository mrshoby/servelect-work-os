...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="policy-contracts-v94" />
      <V200GoodDayCompleteInteractionLayer routeKey="policy-contracts-v94" />
      <V210GoodDayRealMutationBridge routeKey="policy-contracts-v94" />
    </>);
}
