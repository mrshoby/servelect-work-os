...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="saved-view-persistence-v96" /><V190GoodDayInPlaceInteractionCore routeKey="saved-view-persistence-v96" /></>);
}
