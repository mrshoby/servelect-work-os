...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="workload-planner-v91" />
      <V200GoodDayCompleteInteractionLayer routeKey="workload-planner-v91" />
      <V210GoodDayRealMutationBridge routeKey="workload-planner-v91" />
    </>);
}
