...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="manager-gate-inbox-v96" />
      <V200GoodDayCompleteInteractionLayer routeKey="manager-gate-inbox-v96" />
      <V210GoodDayRealMutationBridge routeKey="manager-gate-inbox-v96" />
    </>);
}
