...
export const metadata = { title: "Taskuri Task Detail v9.1 | SERVELECT EMP" };

export default function Page() {
  return <V91GoodDayTaskExecutionParity initial={getV91Workspace()} view="task-detail" surface="taskuri" />;
}
