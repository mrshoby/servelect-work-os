...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="provider-dispatch-ledger-v92" /><V190GoodDayInPlaceInteractionCore routeKey="provider-dispatch-ledger-v92" /></>);
}
