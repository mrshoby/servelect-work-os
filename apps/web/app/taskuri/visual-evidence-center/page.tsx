...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="visual-evidence-center" />
      <V200GoodDayCompleteInteractionLayer routeKey="visual-evidence-center" />
      <V210GoodDayRealMutationBridge routeKey="visual-evidence-center" />
    </>);
}
