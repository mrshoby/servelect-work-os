...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="workload-forecast-v95" />
      <V200GoodDayCompleteInteractionLayer routeKey="workload-forecast-v95" />
      <V210GoodDayRealMutationBridge routeKey="workload-forecast-v95" />
    </>);
}
