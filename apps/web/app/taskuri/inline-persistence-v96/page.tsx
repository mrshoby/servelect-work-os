...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="inline-persistence-v96" />
      <V200GoodDayCompleteInteractionLayer routeKey="inline-persistence-v96" />
      <V210GoodDayRealMutationBridge routeKey="inline-persistence-v96" />
    </>);
}
