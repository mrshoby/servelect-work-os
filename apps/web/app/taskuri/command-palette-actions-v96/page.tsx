...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="command-palette-actions-v96" />
      <V200GoodDayCompleteInteractionLayer routeKey="command-palette-actions-v96" />
      <V210GoodDayRealMutationBridge routeKey="command-palette-actions-v96" />
    </>);
}
