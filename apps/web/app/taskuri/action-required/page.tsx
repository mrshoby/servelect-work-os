...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="action-required" />
      <V200GoodDayCompleteInteractionLayer routeKey="action-required" />
      <V210GoodDayRealMutationBridge routeKey="action-required" />
    </>);
}
