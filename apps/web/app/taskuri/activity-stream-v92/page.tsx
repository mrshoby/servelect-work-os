...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="activity-stream-v92" />
      <V200GoodDayCompleteInteractionLayer routeKey="activity-stream-v92" />
      <V210GoodDayRealMutationBridge routeKey="activity-stream-v92" />
    </>);
}
