...
export default function TaskuriPage() {
  return (<><V150GoodDayStructuralTaskuriWorkspace routeKey="task-template-recurrence-v94" /><V190GoodDayInPlaceInteractionCore routeKey="task-template-recurrence-v94" /></>);
}
