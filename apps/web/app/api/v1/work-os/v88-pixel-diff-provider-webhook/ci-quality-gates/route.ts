...
export async function GET() {
  return NextResponse.json({ ok: true, gates: { typecheck: "required", lint: "required", build: "required", functionalSmoke: "required", screenshotAudit: "required", pixelDiff: "prepared" } });
}
