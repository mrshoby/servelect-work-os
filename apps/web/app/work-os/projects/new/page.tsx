...
export default function Page() {
  ...
  const workflow = getWorkOsWorkflowByEntity("project");
  const template = templates.find((item) => item.entity === "project") ?? templates[0];
  return (
    <WorkOsShell eyebrow="SERVELECT WORK OS v5.3" title="Project Create" subtitle={workflow.description}>
