...
export default function Page() {
  ...
  const workflow = getWorkOsWorkflowByEntity("offer");
  const template = templates.find((item) => item.entity === "offer") ?? templates[0];
  return (
    <WorkOsShell eyebrow="SERVELECT WORK OS v5.3" title="Offer Create" subtitle={workflow.description}>
