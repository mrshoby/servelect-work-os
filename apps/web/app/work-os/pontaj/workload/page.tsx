...
export default function Page() {
  ...
  const workflow = getWorkOsWorkflowByEntity("pontajWorkload");
  const template = templates.find((item) => item.entity === "pontajWorkload") ?? templates[0];
  return (
    <WorkOsShell eyebrow="SERVELECT WORK OS v5.3" title="Pontaj Workload Proposal" subtitle={workflow.description}>
