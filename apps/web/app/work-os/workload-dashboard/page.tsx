...
export default function Page() {
  const data = getWorkloadView();
  const content = (data as Record<string, unknown>)["workload"];
  ...
  return (
    <main className="space-y-6">
      <section className="rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-white via-emerald-50 to-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-black text-slate-950">Pontaj Workload Dashboard</h1>
