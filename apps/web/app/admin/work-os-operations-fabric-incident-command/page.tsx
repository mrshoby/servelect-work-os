  ...
  return (
    <main className="space-y-6">
      <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-black text-slate-950">Work OS Incident Command</h1>
        <p className="mt-3 max-w-5xl text-sm leading-6 text-slate-600">Global incident command and rollback controls</p>
      </section>
