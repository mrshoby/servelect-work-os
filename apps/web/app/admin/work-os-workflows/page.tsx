...
export default function Page() {
  ...
  const workflow = getWorkOsWorkflowByEntity("task");
  const template = templates.find((item) => item.entity === "task") ?? templates[0];
  return (
    <WorkOsShell eyebrow="SERVELECT WORK OS v5.3" title="Admin Work OS Workflows" subtitle={workflow.description}>
