...
export default function Page() {
  const data = getAuditView();
  const content = (data as Record<string, unknown>)["audit"];
  ...
  return (
    <main className="space-y-6">
      <section className="rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-white via-emerald-50 to-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-black text-slate-950">Execution Audit Stream</h1>
